...
//     });
//     issueForProductionSchema['properties']['purchaseOrderId']['enum'] =
//       purchaseOrderIdData;
...
//             from: 'labourexpenses',
//             let: { id: '$_id' },
//             pipeline: [{ $match: { $expr: { $eq: ['$assetId', '$$id'] } } }],
//             as: 'labourExpenseSchema',
//           },
//         },
//         {
...
//               } else {
//                 item.assetId = id;
//                 await this.dryService.create(item).catch((err) => {
//                   throw new HttpException(
//                     err.message,
//                     ResponseCode.BAD_REQUEST,
//                   );
